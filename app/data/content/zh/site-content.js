export const profileContent = {
  ...
  description:
    '我是牛拙Prince，做 UI/UX、AI 产品和人因工程交叉方向的 designer-builder。目前在 Tufts 读 Human Factors Engineering 硕士，本科是 Purdue 计算机工程。\n\n我喜欢产品从抽象想法变成真实东西的那个阶段：判断问题值不值得做，画出第一个能走通的流程，拿粗糙版本去测试，然后把它继续做成别人真的能用的东西。\n\n我的工作介于人因、产品设计和工程之间。我关注那些决定产品清不清楚的细节：提示出现的时机、反馈的方式、出错后的恢复路径，还有用户第一次点击时能不能马上理解。最近我交付了 Porsche Asia Pacific 的 PCM 车载界面工作，做过一个 BLE 姿势追踪 App，发布了 macOS 语音转文字工具 SayIt。我也设计并可用性测试了 TrekAssist，一款户外 e-ink 安全设备，也构建了 KnowledgeOS——一个让 agent 维护持久项目上下文的个人 AI 系统。\n\n我正在寻找产品设计、UX 和人因方向的机会，尤其关注打磨到位的产品、细致的 UI/UX 和复杂的多模态体验。',
  ctaLabel: '联系我',
};
