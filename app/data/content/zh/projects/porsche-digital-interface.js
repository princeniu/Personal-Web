export const porscheProject = {
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          title: '性能优化',
          description:
            '与工程团队迭代微交互和资源权重，让交接的界面稳定运行在平台的渲染预算之内。',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      heading: '加载时间优化',
      body: [
        '加载时间的改善来自于交接期间和之后与工程团队的紧密迭代。组件规范被重写以复用共享原语，动画时长和资源权重根据平台渲染预算进行了调优，多个冗余的过渡状态合并为单一的规范路径。',
    ...
    },
    {
      ...
      metrics: [
        ...
        { value: '4', label: '多模态流程设计并交接（触控 · 语音 · AI · GUI）' },
      ...
      evidence: [
        {
          label: '性能',
          value:
            '微交互和资源权重的迭代调优，可衡量地改善了导航、语音和辅助界面的加载时间。',
        },
        {
          label: '跨职能对齐',
          value:
    ...
    },
    {
      ...
      body: [
        ...
        '我带走的最宝贵习惯是把工程交接视为设计本身的一部分。加载时间降低这样的可衡量成果，是设计与实现共同迭代的产物，而不是某一方把"已完成的工作"抛过墙来的结果。',
      ],
    },
  ],
};
